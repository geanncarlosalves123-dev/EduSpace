...
public class UsuarioDAO {
    ...
    public Usuario buscarPorEmail(String email) throws SQLException {
        final String SQL = "SELECT * FROM usuarios WHERE email = ? AND ativo = true";
    ...
    public List<Usuario> listarProfessores() throws SQLException {
        final String SQL = "SELECT * FROM usuarios WHERE perfil = 'professor' AND ativo = true ORDER BY nome";
    ...
    public boolean desativar(int id) throws SQLException {
        final String SQL = "UPDATE usuarios SET ativo = false WHERE id = ?";
